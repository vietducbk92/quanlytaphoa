 ...
 * @author vietd
 */
public class BillPanel extends javax.swing.JPanel implements BarcodeReader.BarcodeListener, DatabaseManager.DatabaseListener {
     ...
     */
    public BillPanel(JFrame parent) throws UnknownHostException {
        this.parent = parent;
        initComponents();
